...
const (
	CollectorService_GetRepository_FullMethodName = "/CollectorService/GetRepository"
)
...
func (c *collectorServiceClient) GetRepository(ctx context.Context, in *RepositoryRequest, opts ...grpc.CallOption) (*RepositoryResponse, error) {
...
func (UnimplementedCollectorServiceServer) GetRepository(context.Context, *RepositoryRequest) (*RepositoryResponse, error) {
...
func _CollectorService_GetRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CollectorServiceServer).GetRepository(ctx, req.(*RepositoryRequest))
	}
