...
func (x *RepositoryRequest) GetOwnerName() string {
	if x != nil {
		return x.OwnerName
	}
	return ""
...
const file_api_proto_collector_proto_rawDesc = "" +
	"\n" +
	"\x19api/proto/collector.proto\"O\n" +
	"\x11RepositoryRequest\x12\x1d\n" +
	"\n" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\tR\tcreatedAt2L\n" +
	"\x10CollectorService\x128\n" +
	"\rGetRepository\x12\x12.RepositoryRequest\x1a\x13.RepositoryResponseB:Z8github.com/ArtemNik1tin/distributed-github/api/proto/genb\x06proto3"
...
var file_api_proto_collector_proto_goTypes = []any{
	(*RepositoryRequest)(nil),  // 0: RepositoryRequest
	(*RepositoryResponse)(nil), // 1: RepositoryResponse
}
var file_api_proto_collector_proto_depIdxs = []int32{
	0, // 0: CollectorService.GetRepository:input_type -> RepositoryRequest
	1, // 1: CollectorService.GetRepository:output_type -> RepositoryResponse
